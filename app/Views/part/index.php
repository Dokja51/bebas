...
<html lang="en">
  ...
  <link rel="icon" href="<?= base_url('assets/favicon.ico') ?>"><link href="<?= base_url('assets/style.css') ?>" rel="stylesheet"></head>
  <body
    ...
    >
      ...
      <div
        ...
        >
          ...
          <span class="text-theme-sm mr-1 block font-medium"> <?= esc($user->username ?? 'Guest') ?> </span>
...
<?= $this->renderSection('content') ?>
    ...
    <!-- ===== Page Wrapper End ===== -->
  <script defer src="<?=base_url('assets/bundle.js')?>"></script></body>
</html>